...
exploreLog :: EnableBackjumping -> CountConflicts -> Tree (Assignment, a) QGoalReason
           -> ConflictSetLog (Assignment, RevDepMap, a)
exploreLog enableBj (CountConflicts countConflicts) t = cata go t M.empty
  where
    ...
    go :: TreeF (Assignment, a) QGoalReason (ConflictMap -> ConflictSetLog (Assignment, RevDepMap, a))
                                         -> (ConflictMap -> ConflictSetLog (Assignment, RevDepMap, a))
