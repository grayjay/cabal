...
import Distribution.Client.Dependency.Types
         ...
         , InstallPlanScore(..), SolverExhaustiveness(..) )
...
--    fetchOutput    :: Flag FilePath,
      ...
      fetchExhaustiveness   :: Flag SolverExhaustiveness,
...
--  fetchOutput    = mempty,
    ...
    fetchExhaustiveness   = Flag FindFirstSolution,
...
--         (reqArgFlag "PATH")
       ...
       optionSolverFlags showOrParseArgs
                         ...
                         fetchExhaustiveness   (\v flags -> flags { fetchExhaustiveness   = v })
...
data FreezeFlags = FreezeFlags {
      ...
      freezeExhaustiveness   :: Flag SolverExhaustiveness,
...
defaultFreezeFlags = FreezeFlags {
    ...
    freezeExhaustiveness   = Flag FindFirstSolution,
...
freezeCommand = CommandUI {
    ...
    commandOptions      = \ showOrParseArgs -> [
       ...
       optionSolverFlags showOrParseArgs
                         ...
                         freezeExhaustiveness   (\v flags -> flags { freezeExhaustiveness   = v })
...
data InstallFlags = InstallFlags {
    ...
    installExhaustiveness   :: Flag SolverExhaustiveness,
...
defaultInstallFlags = InstallFlags {
    ...
    installExhaustiveness  = Flag FindFirstSolution,
...
installOptions showOrParseArgs =
      ...
      optionSolverFlags showOrParseArgs
                        ...
                        installExhaustiveness   (\v flags -> flags { installExhaustiveness   = v })
...
optionSolverFlags :: ShowOrParseArgs
                  ...
                  -> (flags -> Flag SolverExhaustiveness) -> (Flag SolverExhaustiveness -> flags -> flags)
                  -> (flags -> Flag Bool  ) -> (Flag Bool   -> flags -> flags)
                  -> (flags -> Flag Bool  ) -> (Flag Bool   -> flags -> flags)
                  -> (flags -> Flag Bool  ) -> (Flag Bool   -> flags -> flags)
                  -> (flags -> Flag Bool  ) -> (Flag Bool   -> flags -> flags)
                  -> [OptionField flags]
optionSolverFlags showOrParseArgs getmbj setmbj getms setms getse setse getrg setrg _getig _setig getsip setsip getstrfl setstrfl =
  ...
  , option [] ["find-best-solution"]
      ...
      (let exhToBool FindBestSolution  = True
           exhToBool FindFirstSolution = False
      in fmap exhToBool . getse)
      (let boolToExh best = if best then FindBestSolution else FindFirstSolution
      in setse . fmap boolToExh)
      (yesNoOpt showOrParseArgs)
